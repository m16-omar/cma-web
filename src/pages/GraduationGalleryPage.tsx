...
const galleryItems: GalleryItem[] = [
  {
    ...
    description: 'The graduating set of Cohort 31 celebrating their completion of the 5-week intensive broadcast media program.',
  ...
  },
  {
    ...
    description: 'Cohort 26 graduating class posing after recording their final syndicated radio show broadcast.',
    aspect: 'col-span-1 aspect-[4/3]',
  },
  {
    id: 'gal-8',
