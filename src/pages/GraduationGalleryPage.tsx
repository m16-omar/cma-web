...
const galleryItems: GalleryItem[] = [
  {
    id: 'gal-1',
    title: 'Broadcast Media Pro Cohort 24 Convocation',
    category: 'Class of 2026',
    cohort: 'Cohort 24',
    date: 'August 2026',
    location: 'City FM Broadcast Complex',
    image: '/images/cma_classroom_real.jpg',
    description: 'The graduating set of Cohort 24 celebrating their completion of the 5-week intensive broadcast media program.',
    aspect: 'col-span-1 lg:col-span-2 aspect-[16/10]',
  },
  {
    id: 'gal-2',
    title: 'City Media Academy Students Classroom Lecture',
    category: 'Studio Sessions',
    cohort: 'Cohort 24',
    date: 'July 2026',
    location: 'Ikeja Training Studio',
    image: '/images/cma_students_classroom.jpg',
    description: 'Hands-on broadcast journalism and on-air presentation lecture in session at CMA Ikeja campus.',
    aspect: 'col-span-1 aspect-[4/3]',
  },
  {
    id: 'gal-3',
    title: 'City 105.1 FM Headquarters & Live Studio Experience',
    category: 'Studio Sessions',
    cohort: 'Cohort 23 & 24',
    date: 'June 2026',
    location: 'Plot 11 Lateef Jakande Road, Ikeja',
    image: '/images/cityfm_building_real.jpg',
    description: 'Graduates undergoing practical on-air radio training and live studio broadcasting at City 105.1 FM.',
    aspect: 'col-span-1 aspect-[4/3]',
  },
  {
    id: 'gal-4',
    title: 'State-of-the-Art Broadcast Studio Masterclass',
    category: 'Studio Sessions',
    cohort: 'Executive Masterclass',
    date: 'May 2026',
    location: 'CMA Studio One',
    image: '/images/cma_classroom_ai.jpg',
    description: 'Students receiving interactive mentorship in acoustic direction, live audio consoles, and vocal control.',
    aspect: 'col-span-1 aspect-[4/3]',
  },
  {
    id: 'gal-5',
    title: 'Grand Convocation & Certificate Presentation',
  ...
  {
    id: 'gal-6',
    title: 'Media Trailblazer & Best On-Air Presenter Award',
    category: 'Awards & Honors',
    cohort: 'Annual Honors',
    date: 'December 2025',
    location: 'CMA Honors Gala',
    image: 'https://images.unsplash.com/photo-1577495508048-b635879837f1?q=80&w=1000&auto=format&fit=crop',
    description: 'Recognizing outstanding student projects, podcast pilots, and voiceover commercial productions.',
    aspect: 'col-span-1 aspect-[4/3]',
  },
  {
    id: 'gal-7',
    title: 'Voiceover & Podcast Production Class Group',
    category: 'Class of 2025',
    cohort: 'Cohort 21',
    date: 'October 2025',
    location: 'City 105.1 FM Sound Booths',
    image: 'https://images.unsplash.com/photo-1511578314322-379afb476865?q=80&w=1000&auto=format&fit=crop',
    description: 'Cohort 21 graduating class posing after recording their final syndicated radio show broadcast.',
    aspect: 'col-span-1 aspect-[4/3]',
  },
  {
    id: 'gal-8',
    title: 'Alumni Network & Station Placement Welcome',
    category: 'Awards & Honors',
    cohort: 'Alumni Network',
    date: 'Annual Meet',
    location: 'Lagos Creative Hub',
    image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=1000&auto=format&fit=crop',
    description: 'Welcoming new CMA certified graduates into national radio, television, and podcasting networks.',
    aspect: 'col-span-1 aspect-[4/3]',
  },
];
...
const stats = [
  ...
  { label: 'Graduation Sets', value: '24 Cohorts' },
